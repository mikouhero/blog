...
var ias=$.ias({container:".blog-layout",item:".post_box,.sandraItem",pagination:" ",next:".pagination a.next",});ias.extension(new IASTriggerExtension({text:'\u52a0\u8f7d\u66f4\u591a',offset:1,}));ias.extension(new IASSpinnerExtension());ias.extension(new IASNoneLeftExtension({text:'\u522b\u70b9\u5566\uff0c\u6211\u662f\u6709\u5e95\u7ebf\u7684\u007e',}));ias.on('rendered',function(items){$(".blog-layout img").lazyload({effect:"fadeIn",failure_limit:10})})
//});